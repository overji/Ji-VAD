...
class Wav2Vec2ForEndpointing(Wav2Vec2PreTrainedModel):
    ...
    def forward(self, input_values, attention_mask=None, labels=None):
        ...
        # outputs[0]: (batch_size, sequence_length, hidden_size)，this is hidden state?
        # outputs[1]: (batch_size, sequence_length, xvector_output_dim), this is mainly final vectors
        # here the hidden_size is usually 768
